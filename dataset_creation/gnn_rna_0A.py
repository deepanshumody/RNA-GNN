# -*- coding: utf-8 -*-
"""Dataset-creation variant of gnn_rna.py.

This variant builds RNA graph pickles using a spatial grid that stops at 0A
from the molecule edge (grid bounds derived directly from the atom coordinate
extents). It is otherwise the same dataset-creation pipeline as gnn_rna.py.
"""
